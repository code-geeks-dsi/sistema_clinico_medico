...
from modulo_expediente.views import CreateHojaEvolucion, ListaHojaEvolucion, ReferenciaMedicaUpdate, agregar_medicamento, busqueda_paciente, autocompletado_apellidos, eliminar_cola, eliminar_dosis,sala_consulta,get_cola,get_paciente,agregar_cola, modificar_signosVitales, crear_expediente, editar_consulta
