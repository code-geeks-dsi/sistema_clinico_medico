...
from modulo_expediente.serializers import (
    DosisListSerializer, MedicamentoSerializer, PacienteSerializer, ContieneConsultaSerializer, DocumentoExternoSerializer)
...
##Para cargar las variables de netorno
env = environ.Env()
