...
const detallesPromocionMedica=(indexServicio, indexPublicacion)=>{
    ...
    <div class="card-body text-center">
      ...
      <div class="fb-share-button" data-href="https://sistema-clinico-medico.herokuapp.com/consultorio/#promo-${publicacion.id_publicacion}" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fsistema-clinico-medico.herokuapp.com%2Fconsultorio%2F%23promo-${publicacion.id_publicacion}&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Compartir</a></div>
    </div>
    `
